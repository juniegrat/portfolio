    ...
    per === 'line' ? (
      ...
      <motion.span className="inline-block whitespace-pre">
        {segment.split('').map((char, charIndex) => (
          <motion.span
            // biome-ignore lint/suspicious/noArrayIndexKey: char position is the stable identity for the reveal
            key={`char-${charIndex}`}
            aria-hidden="true"
            variants={variants}
      ...
      {trigger && (
        ...
        >
          ...
          {segments.map((segment, index) => (
            <AnimationComponent
              // biome-ignore lint/suspicious/noArrayIndexKey: segment position is the stable identity for the reveal
