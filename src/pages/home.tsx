  ...
  return (
    <main className="relative space-y-16 sm:space-y-24">
      ...
      <section id="projects" {...enter(1)}>
        <h2 className="mb-5 text-lg font-medium text-ink">
          {intl.formatMessage({ id: 'home.projects' })}
        </h2>
          ...
          {PROJECTS.map((project, index) => (
            <div key={project.id} className="reveal space-y-2">
              ...
              <div className="px-1">
                ...
                <p className="mt-0.5 text-base text-muted">{project.description[locale]}</p>
      ...
      <section id="capabilities" {...enter(2)}>
        <h2 className="mb-5 text-lg font-medium text-ink">
          {intl.formatMessage({ id: 'home.capabilities' })}
        </h2>
        <div className="divide-y divide-line border-t border-line">
          {CAPABILITIES.map((capability) => (
            ...
            >
              <h3 className="font-mono text-xs text-accent sm:pt-1">{capability.label[locale]}</h3>
              <div>
                <p className="text-base text-muted">{capability.summary[locale]}</p>
                <div className="mt-2 flex flex-wrap gap-1.5">
      ...
      <section id="blog" {...enter(3)}>
        <div className="mb-3 flex items-baseline justify-between gap-3">
          <h2 className="text-lg font-medium text-ink">
            {intl.formatMessage({ id: 'home.writing' })}
          </h2>
          <LocaleLink
            to="/blog"
            ...
            {BLOG_POSTS.map((post) => (
              ...
              >
                <div className="flex flex-col space-y-1">
                  <h3 className="font-normal text-ink">{post.title[locale]}</h3>
                  <p className="text-muted">{post.description[locale]}</p>
                </div>
              </LocaleLink>
            ))}
          </AnimatedBackground>
      ...
      <section id="connect" {...enter(4)}>
        <h2 className="mb-5 text-lg font-medium text-ink">
          {intl.formatMessage({ id: 'home.connect' })}
        </h2>
