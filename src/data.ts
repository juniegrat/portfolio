...
export const PROJECTS: Project[] = [
  ...
  },
  {
    name: 'Kalunza',
    description: {
      en: 'Brand, storefront and catalog tooling for a Soweto-made Shweshwe passport holder. A live Shopify theme, a scripted catalog pipeline in Python, and a deployable pitch site used to settle the design direction before any of it was built.',
      fr: 'Marque, boutique et outillage catalogue pour un porte-passeport en shweshwe fabriqué à Soweto. Un thème Shopify en production, un pipeline catalogue scripté en Python, et un site de proposition déployable qui a servi à trancher la direction artistique avant de construire quoi que ce soit.',
    },
    link: 'https://kalunza.com',
    tech: ['Shopify', 'Liquid', 'Python', 'Vercel'],
    year: '2026',
    image: '/projects/kalunza.webp',
    id: 'kalunza',
    slug: 'kalunza',
  },
  {
  ...
  },
  {
    ...
    description: {
      ...
      fr: 'Mémoire de réunion locale pour macOS. Enregistre le son système et le micro, sépare les locuteurs par diarisation pyannote et transcrit en local : rien ne quitte la machine. Livré avec une application iOS compagnon.',
    },
    tech: ['Swift', 'pyannote', 'Whisper', 'Apple Silicon'],
    year: '2026',
  ...
  },
  {
    name: 'Shirei',
    description: {
      en: 'Terminal mission control for every repository on the machine. Git state, dependency drift and per-project checks behind a zero-dependency JSON API and an Ink TUI that needs no build step, with an optional browser dashboard.',
      fr: 'Poste de commande en terminal pour tous les dépôts de la machine. État git, dérive des dépendances et vérifications par projet derrière une API JSON sans dépendances et une interface Ink qui ne demande aucune étape de build, avec un tableau de bord navigateur optionnel.',
    },
    tech: ['TypeScript', 'Ink', 'Clack', 'Node'],
    year: '2026',
    image: '/projects/shirei.webp',
    id: 'shirei',
  },
  {
    name: 'Vercel Glance',
    description: {
      en: 'Deployment alerts on the phone the moment a build goes green or red. A Cloudflare Worker verifies the webhook signature and fans out to push, behind an Expo app carrying deployments, build logs and projects.',
      fr: "Des alertes de déploiement sur le téléphone dès qu'un build passe au vert ou au rouge. Un Worker Cloudflare vérifie la signature du webhook et diffuse les notifications, derrière une application Expo qui porte déploiements, journaux de build et projets.",
    },
    tech: ['Expo', 'Cloudflare Workers', 'React Native', 'ntfy'],
    year: '2026',
    image: '/projects/vercel-glance.webp',
    id: 'vercel-glance',
  },
  {
    name: 'QuotaGlance',
    description: {
      en: 'A macOS menu-bar reading of AI subscription limits, reset windows and spend across providers, each pulled from its own first-party endpoint rather than scraped, so three dashboards collapse into one glance.',
      fr: "Une lecture en barre de menus macOS des limites d'abonnement IA, des fenêtres de réinitialisation et des dépenses par fournisseur, chacune tirée de son endpoint officiel plutôt que scrapée : trois tableaux de bord se réduisent à un coup d'œil.",
    },
    tech: ['Swift', 'SwiftUI', 'macOS'],
    year: '2026',
    image: '/projects/quota-glance.webp',
    id: 'quota-glance',
  },
  {
    name: 'Coin Detector',
  ...
  },
  {
    ...
    link: 'https://aurum.juniegrat.com',
